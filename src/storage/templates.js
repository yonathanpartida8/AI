...
export const BLOCKS = {
  romanticHero: { label: 'Portada romántica', build: romanticHeroBlock },
  letter: { label: 'Carta de amor', build: letterBlock },
  timelineB: { label: 'Nuestra historia (línea de tiempo)', build: timelineBlock },
  countdownB: { label: 'Contador de amor', build: countdownBlock },
  polaroids: { label: 'Fotos polaroid', build: polaroidsBlock },
  secret: { label: 'Mensaje secreto', build: secretBlock },
  chapter: { label: 'Capítulo de historia', build: chapterBlock },
  music: { label: 'Nuestra canción', build: musicBlock },
  reasons: { label: 'Razones por las que te amo', build: reasonsBlock },
  coupons: { label: 'Cupones de amor', build: couponsBlock },
  question: { label: 'La gran pregunta (Sí/No)', build: questionBlock },
  gift: { label: 'Regalos por abrir', build: giftBlock },
  calendar: { label: 'Fecha para recordar', build: calendarBlock },
  game: { label: 'Juego: atrapa mi corazón', build: gameBlock },
  hero: { label: 'Portada estrellada', build: heroBlock },
  features: { label: 'Tres detalles (tarjetas)', build: featuresBlock },
  quote: { label: 'Frase para enmarcar', build: quoteBlock },
  gallery: { label: 'Galería', build: galleryBlock },
  faq: { label: 'Cosas que me preguntas', build: faqBlock },
  contact: { label: 'Mensajito para mí', build: contactBlock },
  cta: { label: 'Invitación especial', build: ctaBlock },
  footer: { label: 'Pie de página', build: footerBlock },
};
